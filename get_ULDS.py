...
#19720121, # @lille3000
#82892603, # @MEL_Lille
#340219904, # @univ_lille
26031424, # @MartineAubry
#577342970, # @pdesaintignon
1026932791051800576, #test user
]
...
print(f'user data set has {len(df)} rows')
...
sys.stdout.flush()
user_data_set.collect_geo_users(twitter,min_num_geo=100) 
phi=fit_LR(user_data_set,label_radius,'Iteration{0:d}_LogReg_ROC'.format(iteration))
a, b, G= user_data_set.classify_step(phi,psi)
...
print("Iteration complete, beginning post-collection phase ")
### Complete the record
